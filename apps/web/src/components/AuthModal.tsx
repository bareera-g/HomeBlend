...
export default function AuthModal({ open, onClose }: Props) {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    // sign-in success → AuthProvider closes modal automatically via onAuthStateChange
  }
          ...
          {success ? (
            ...
            <>
              ...
              <button
                ...
                disabled={loading}
                className="w-full flex items-center justify-center gap-3 py-2.5 rounded-xl border border-gray-200 bg-white hover:bg-gray-50 text-sm font-medium text-gray-700 transition-colors disabled:opacity-50"
              >
